...
export const t: Record<string, Record<Lang, string>> = {
  ...
  scannerConditions:  { ar: 'آخر شروط فُحصت',           en: 'Last Checked Conditions' },
  ...
  stScannerCreate:    { ar: 'تشغيل السكانر',              en: 'Start Scanner' },
  stEntryUsdt:        { ar: 'مبلغ الدخول (USDT)',         en: 'Entry Amount (USDT)' },
  stTp1:              { ar: 'TP1 %',                      en: 'TP1 %' },
  stTp2:              { ar: 'TP2 %',                      en: 'TP2 %' },
  stTp3:              { ar: 'TP3 %',                      en: 'TP3 %' },
  noStScanners:       { ar: 'لا توجد سكانرات Supertrend', en: 'No Supertrend scanners yet' },
  noStScannersDesc:   { ar: 'أنشئ سكانراً للسكالبينج التلقائي على فريم 5 دقائق', en: 'Create a scanner for automatic 5-min scalping' },
  scannerLastSymbol:  { ar: 'آخر عملة فُحصت',           en: 'Last scanned' },
