...
from bot.handlers.start import start_handler, help_handler, menu_command, main_menu_callback
...
def build_app() -> Application:
    ...
    threshold_conv = ConversationHandler(
        ...
        states={
            SET_THRESHOLD: [MessageHandler(TEXT, set_threshold_input)],
        },
        fallbacks=[
            CommandHandler("cancel", cancel_conv),
            CallbackQueryHandler(cancel_conv, pattern="^cancel$"),
    ...
    interval_conv = ConversationHandler(
        ...
        states={
            SET_INTERVAL: [MessageHandler(TEXT, set_interval_input)],
        },
        fallbacks=[
            CommandHandler("cancel", cancel_conv),
            CallbackQueryHandler(cancel_conv, pattern="^cancel$"),
    ...
    create_portfolio_conv = ConversationHandler(
        ...
        fallbacks=[
            CommandHandler("cancel", cancel_portfolio_conv),
    ...
    edit_name_conv = ConversationHandler(
        ...
        states={
            EDIT_NAME: [MessageHandler(TEXT, edit_portfolio_name_input)],
        },
        fallbacks=[
            CommandHandler("cancel", cancel_portfolio_conv),
            CallbackQueryHandler(cancel_portfolio_conv, pattern="^cancel$"),
    ...
    edit_capital_conv = ConversationHandler(
        ...
        states={
            EDIT_CAPITAL: [MessageHandler(TEXT, edit_portfolio_capital_input)],
        },
        fallbacks=[
            CommandHandler("cancel", cancel_portfolio_conv),
            CallbackQueryHandler(cancel_portfolio_conv, pattern="^cancel$"),
